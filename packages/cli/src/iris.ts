...
// (tests/manual/cloudflare-workers-smoke.ts) to a turnkey, TESTED command: read the image,
...
// SAME @irisrun/core unchanged on workerd (generalizes tests/manual/cloudflare-workers-smoke.ts).
