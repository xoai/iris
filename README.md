...
<p align="center">
  ...
  <img alt="tests: 1031 passing" src="https://img.shields.io/badge/tests-1031%20passing-44CC11?style=for-the-badge&labelColor=000000">
...
The unit suite is **install-free, deterministic, zero-dependency** — **1031 passing** on Node 24 (plus **6** live-provider conformance tests gated on API keys), `tsc --noEmit` clean. Every claim here is regression-locked:
...
```sh
npm test                                 # the whole suite → 1031 passing (6 live-conformance tests gated on API keys)
