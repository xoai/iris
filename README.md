...
![Node](https://img.shields.io/badge/node-%E2%89%A5%2024-339933?logo=nodedotjs&logoColor=white) ![runtime deps](https://img.shields.io/badge/runtime%20deps-0-success) ![tests](https://img.shields.io/badge/tests-568%2F568-success) ![license](https://img.shields.io/badge/license-MIT-blue)
...
npm test               # NODE_OPTIONS=--conditions=iris-src node --test 'tests/**/*.test.ts'  → 568/568
...
```sh
npm test                                 # the whole suite → 568/568
